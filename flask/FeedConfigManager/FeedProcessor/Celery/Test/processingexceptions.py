...
"""
    ...
    def __init__(self, file, lineno, line):
        ...
        RowSchemaMismatchException.__init__(
            self, file, lineno, line, "Line has more columns than defined in the Schema")
...
"""
    ...
    def __init__(self, file, lineno, line):
        ...
        RowSchemaMismatchException.__init__(
            self, file, lineno, line, "Line has fewer columns than defined in the Schema")
